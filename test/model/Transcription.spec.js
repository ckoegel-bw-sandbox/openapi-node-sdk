...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSdk.Transcription();
  });
  ...
  describe('Transcription', function() {
    it('should create an instance of Transcription', function() {
      ...
      //var instane = new NodeSdk.Transcription();
      //expect(instance).to.be.a(NodeSdk.Transcription);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new NodeSdk.Transcription();
