...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSdk.Subscriptions();
  });
  ...
  describe('Subscriptions', function() {
    it('should create an instance of Subscriptions', function() {
      ...
      //var instane = new NodeSdk.Subscriptions();
      //expect(instance).to.be.a(NodeSdk.Subscriptions);
    });
    ...
    it('should have the property sessionId (base name: "sessionId")', function() {
      ...
      //var instance = new NodeSdk.Subscriptions();
