...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSdk.BandwidthMessagesList();
  });
  ...
  describe('BandwidthMessagesList', function() {
    it('should create an instance of BandwidthMessagesList', function() {
      // uncomment below and update the code to test BandwidthMessagesList
      //var instane = new NodeSdk.BandwidthMessagesList();
      //expect(instance).to.be.a(NodeSdk.BandwidthMessagesList);
    });
    ...
    it('should have the property totalCount (base name: "totalCount")', function() {
      ...
      //var instance = new NodeSdk.BandwidthMessagesList();
